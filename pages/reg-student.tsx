    ...
    <>
      ...
      <Container maxW="997px">
        ...
        scrollableYearDropdown
            ...
            <FormControl isInvalid={!!errors.competitionCategory} id="email">
              <FormLabel
                opacity="0.7"
                color="#301446"
                fontSize="14px"
          ...
          >
            ...
            <FormControl id="regno" isInvalid={!!errors.phoneNumber}>
              ...
              <Text mt="5px" color="brand.orange">
                {errors.phoneNumber &&
                  " uLesson Registered Phone Number is required"}
              </Text>
            </FormControl>
          ...
          >
            ...
            >
              ...
              />
              <Text mt="5px" color="brand.orange" h="2.5rem">
                {errors.representativePhone &&
                  " Principal’s Phone Number is required"}
              </Text>
            </FormControl>
          </SimpleGrid>
